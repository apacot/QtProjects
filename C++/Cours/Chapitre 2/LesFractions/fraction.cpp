...
Fraction::Fraction(const int _numerateur,const int _denominateur) : numerateur(_numerateur), denominateur(_denominateur) //liste d'initialisation
{
    int pgdc = CalculerPgdc(numerateur, denominateur);
...
int Fraction::CalculerPgdc(int _a, int _b)
{
    int min;
    if(_a < _b)
    {
