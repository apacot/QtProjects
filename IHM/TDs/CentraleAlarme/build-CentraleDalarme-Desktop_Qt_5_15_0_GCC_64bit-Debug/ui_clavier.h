...
public:
    ...
    void setupUi(QWidget *Clavier)
    {
        ...
        Clavier->resize(295, 194);
        widget = new QWidget(Clavier);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(20, 10, 179, 24));
        ...
        widget1->setGeometry(QRect(20, 50, 254, 116));
    ...
    void retranslateUi(QWidget *Clavier)
    {
        ...
        pushButton_Arret->setText(QCoreApplication::translate("Clavier", "Arr\303\252t", nullptr));
    } // retranslateUi
